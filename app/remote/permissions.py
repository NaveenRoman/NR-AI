...
ACTION_SCOPE_MAP: Dict[str, PhonePermissionScope] = {
    ...
    "action.remote_execute": PhonePermissionScope.APPROVED_COMPUTER_ACTION,
    "action.remote_confirm": PhonePermissionScope.APPROVED_COMPUTER_ACTION,
    "action.remote_cancel": PhonePermissionScope.APPROVED_COMPUTER_ACTION,
    "action.remote_status": PhonePermissionScope.READ_STATUS,
